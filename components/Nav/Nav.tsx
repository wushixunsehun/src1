...
const Nav = memo(
  ({
    ...
    const isNewConversationPage = location.pathname === '/c/new';
  ...
  () => (
    <>
      ...
      {hasAccessToBookmarks && !isNewConversationPage && (
        <>
          <div className="mt-1.5" />
          <Suspense fallback={null}>
            <BookmarkNav tags={tags} setTags={setTags} isSmallScreen={isSmallScreen} />
  ...
  [hasAccessToBookmarks, tags, isSmallScreen,  isNewConversationPage],
);
